...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cmd_statistics->Text = L"Ëè÷íàÿ ñòàòèñòèêà";
			...
			this->cmd_test->Text = L"Íà÷àòü òåñòèðîâàíèå";
			...
			this->label7->Text = L"Òåñò ïî òåìå «Ôèçè÷åñêèå îñíîâû \r\níàíîòåõíîëîãèé ôîòîíèêè è îïòîèíôîðìàòèêè»\r\n\r\n";
			...
			this->button1->Text = L"Âûéòè èç àêêàóòíòà";
			...
			this->label2->Text = L"Ïåðåä ïðîõîæäåíèåì òåñòèðîâàíèÿ ðåêîìåíäóåì îçíàêîìèòüñÿ ñ òåîðèåé";
			...
			this->Text = L"Òåñò ïî íàíîôèçèêå - Ëè÷íàÿ ñòðàíèöà";
