...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Âûïîëíåí âõîä â ó÷åòíóþ çàïèñü ïîëÿçîâàòåëÿ";
			// 
			// button1
			// 
			...
			this->label2->Text = L"Ðåçóëüòàòû ïðîõîæäåíèÿ òåñòà ";
			// 
			// chart1
			// 
...
private: System::Void OwnStatisticsForm_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	if (count == 0) {
		dataGridView1->Hide();
		chart1->Hide();
		label2->Text = "Âû åù¸ íå ïðîõîäèëè òåñòèðîâàíèå.";
	}
	else {
		...
		dataGridView1->Rows[0]->Cells[0]->Value = "Äàòà ïðîõîæäåíèÿ";
		dataGridView1->Rows[0]->Cells[1]->Value = "Êîëè÷åñòâî ïðàâèëüíûõ îòâåòîâ";
		dataGridView1->Rows[0]->Cells[2]->Value = "Îöåíêà ";
		...
		chart1->Series["0"]->Points->AddXY("îöåíêà 5", c5);
		chart1->Series["0"]->Points->AddXY("îöåíêà 4", c4);
		chart1->Series["0"]->Points->AddXY("îöåíêà 3", c3);
		chart1->Series["0"]->Points->AddXY("îöåíêà 2", c2);
	}
}
