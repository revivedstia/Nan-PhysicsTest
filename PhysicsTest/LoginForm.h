...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cmd_to_home->Text = L"Íà ãëàâíóþ";
			...
			this->cmd_to_signin->Text = L"Çàðåãèñòèðèðîâàòüñÿ";
			...
			this->label4->Text = L"Ó ìåíÿ íåò àêêàóíòà ";
			// 
			// cmd_login
			// 
			...
			this->label1->Text = L"Âõîä â ëè÷íûé êàáèíåò";
			// 
			// txtLogin
			// 
			...
			this->Text = L"Òåñò ïî íàíîôèçèêå - Àâòîðèçàöèÿ";
...
private: System::Void cmd_login_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (login == "") {
		MessageBox::Show("Ïîëå \"Ëîãèí\" íå çïîëíåíî", "Ñîîáùåíèå",
			MessageBoxButtons::OK, MessageBoxIcon::Information);
		return;
	}

	if (pass == "") {
		MessageBox::Show("Ïîëå \"Ïàðîëü\" íå çïîëíåíî", "Ñîîáùåíèå",
			MessageBoxButtons::OK, MessageBoxIcon::Information);
		return;
	}

	if (user_login == "") {
		MessageBox::Show("Ïîëüçîâàòåëÿ ñ òàêèì ëîãèíîì íå ñóùåñòâóåò", "Îøèáêà",
			MessageBoxButtons::OK, MessageBoxIcon::Error);
		return;
	}

	if (Class1::UserPassword("users.txt", user_login) != pass) {
		MessageBox::Show("Ïàðîëü íå âåðíûé", "Îøèáêà",
			MessageBoxButtons::OK, MessageBoxIcon::Error);
		return;
	}
