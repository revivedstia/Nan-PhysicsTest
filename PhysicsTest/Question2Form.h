...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Âîïðîñ ¹2\r\n\r\nÍàçîâèòå ïðèìåðû ôîòîííîãî ôðàêòàëà\r\n";
			// 
			// cmdNext
			// 
			...
			this->checkBox1->Text = L"Ðàêîâèíà Øèëëèíãà";
			...
			this->groupBox1->Text = L"Âû ìîæåòå âûáðàòü íåñêîëüêî îòâåòîâ";
			// 
			// checkBox3
			// 
			...
			this->checkBox3->Text = L"Êîâåð Ñåðïèíñêîãî";
			...
			this->checkBox2->Text = L"Ñíåæèíêà Ôåéíìàíà";
			...
			this->checkBox4->Text = L"Ãóáêà Ìåíãåðà";
			...
			this->Text = L"Òåñò ïî íàíîôèçèêå - 2 âîïðîñ";
...
#pragma endregion
	private: System::Void cmdNext_Click(System::Object^ sender, System::EventArgs^ e) {
		if ((!checkBox1->Checked) && (!checkBox2->Checked) && (!checkBox3->Checked) &&
			(!checkBox4->Checked))
			MessageBox::Show("Âûáåðèòå õîòÿ áû îäèí âàðèàíò îòâåòà", "Îøèáêà",
				MessageBoxButtons::OK, MessageBoxIcon::Information);
		else {
			if ((checkBox1->Checked) && (!checkBox2->Checked) && // ïðàâèëüíûå îòâåòû 134 
